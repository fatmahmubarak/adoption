...
//        recyclerView.addItemDecoration(new DividerItemDecoration(this.getActivity(),DividerItemDecoration.VERTICAL));
        ...
        Tips t2 = new Tips( "توفير البيئة النظيفة والآمنة لكلبك؛ حيث يجب أن يكون مأوى الكلب نظيفًا وخاليًا من المخاطر.\n\n\n" +
                "توفير نظام غذائي صحي للكلب؛ بحيث يكون مغذيًا ويمنع السمنة ويفضل اتباع التوصيات الغذائية التي ينصحك بها الطبيب البيطري وفقًا للاحتياجات الغذائية لكلبك، وهو يعتمد بذلك على حجم وعمر وسلالة الكلب، ويجب توفير المياه العذبة بشكلٍ دائمٍ للكلب.\n\n\n"  ,R.drawable.dog2,"نصائح لتربية الكلاب");
